...
newlist = [int(x) for x in numbers if x > 0]  # johnnys way
...
word_length = [len(word) for word in words if word != "the"]  # johnnys way)
# result = [len(words) for sentence in sentence if words != "the" in sentence]
print(word_length)
